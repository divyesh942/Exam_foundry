...
const AddQuestion = () => {
    ...
    const fetchSubjects = async () => {
        try {
            ...
            setSubjectOptions(subjectsData || []); // Ensure subjectsData is an array or default to empty array
        } catch (error) {
            console.error(error);
        }
    };
    ...
    const handleAddChoice = () => {
        const lastChoice = choices[choices.length - 1] || "A"; // Ensure lastChoice has a default value
